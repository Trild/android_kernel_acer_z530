...
static int s4AF_WriteReg(u16 a_u2Data)
{
    ...
    int  i4RetValue = 0;
#ifdef ENABLE_SRC_DLC
    /* {(char)(a_u2Data >> 4) , (char)(((a_u2Data & 0xF) << 4)+S[3:2]<<2 +S[1:0])}
      * S[3:2] = 01:  Codes Per Step = 1
      */
    char puSendCmd[2] = {(u8)(a_u2Data >> 4) , (u8)((a_u2Data & 0xF)<<4 | (0x1<<2))};
#else
    char puSendCmd[2] = {(u8)(a_u2Data >> 4) , (char)((a_u2Data & 0xF) << 4)};
#endif
...
#ifdef ENABLE_SRC_DLC
/* Dual level control */
static int af_init_src(void)
{
    int ret = 0;
    //step1: Protection off
    char puSendCmd1[2] = {(0xEC), (0xA3)};
    //step2: DLC[3]=1 & MCLK[1:0] = 10b
    char puSendCmd2[2] = {(0xA1), (0x0E)};
    //step3: T_SRC[4:0]=10110b
    char puSendCmd3[2] = {(0xF2), (0x16)<<3};
    //step4: Protection on
